...
// 注册
export function postRegistry(params: unknown) {
  return request.post<ResponseLoginData>('/api/registry', params)
}

// 获取用户信息
export function postUserInfo(params: unknown) {
  return request.post<UserInfo>('/api/user/info', params)
}
